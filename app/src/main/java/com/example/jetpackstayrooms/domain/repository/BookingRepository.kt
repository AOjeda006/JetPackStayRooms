...
interface BookingRepository {
     ...
     * [com.example.jetpackstayrooms.domain.usecase.CancelBookingUseCase].
     */
    suspend fun cancelBooking(bookingId: Long)

    /**
     * Flujo con las reservas en estado [com.example.jetpackstayrooms.domain.BookingStatus.ACTIVE]
     ...
     * [com.example.jetpackstayrooms.domain.BookingStatus.ACTIVE] apuntan a la
